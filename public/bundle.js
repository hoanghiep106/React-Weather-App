	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            this.state.isLoading ? React.createElement(
	                ...
	                null,
	                'Loading weather'
	            ) : this.state.location && this.state.temp ? React.createElement(WeatherMessage, { location: this.state.location, temp: this.state.temp }) : null
	        );
	    }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=9df406eed86122f1f1b60f97eecbd4d6&q=';
